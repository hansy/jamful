/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .env.cf-generate` (hash: 2ac5b3f3c1cb56ef9f78697616d9456c)
// Runtime types generated with workerd@1.20260415.1 2026-04-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserPresenceDO" | "UserInboxDO";
	}
	interface Env {
		JAMFUL_KV: KVNamespace;
		JAMFUL_DB: D1Database;
		PRESENCE_QUEUE: Queue;
		GRAPH_SYNC_QUEUE: Queue;
		JWT_ISSUER: "jamful";
		SESSION_EXPIRY_MS: "120000";
		ENVIRONMENT: "development";
		X_FOLLOW_SYNC_MAX_PAGES: "25";
		JWT_SECRET: string;
		X_CLIENT_ID: string;
		X_CLIENT_SECRET: string;
		X_REFRESH_TOKEN_ENC_KEY: string;
		X_REFRESH_TOKEN_ENC_KID: string;
		USER_PRESENCE: DurableObjectNamespace<import("./src/index").UserPresenceDO>;
		USER_INBOX: DurableObjectNamespace<import("./src/index").UserInboxDO>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_ISSUER" | "SESSION_EXPIRY_MS" | "ENVIRONMENT" | "X_FOLLOW_SYNC_MAX_PAGES" | "JWT_SECRET" | "X_CLIENT_ID" | "X_CLIENT_SECRET" | "X_REFRESH_TOKEN_ENC_KEY" | "X_REFRESH_TOKEN_ENC_KID">> {}
}
