/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file .env.local` (hash: 24bcef3e8b31c6679b6bb9a736675b0c)
// Runtime types generated with workerd@1.20260415.1 2026-04-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserPresenceDO";
	}
	interface Env {
		JAMFUL_D1: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "X_CLIENT_ID" | "X_CLIENT_SECRET" | "X_REFRESH_TOKEN_ENC_KEY" | "X_REFRESH_TOKEN_ENC_KID">> {}
}
